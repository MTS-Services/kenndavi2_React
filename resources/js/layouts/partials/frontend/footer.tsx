...
export function FrontendFooter() {
    return (
          ...
          <footer className="bg-[var(--bg-white-secondary)] px-6 py-12 text-[var(--bg-black)]">
          <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-4">
              ...
              <div className="flex space-x-2">
                  <a href="#" className="flex h-10 w-10 items-center justify-center rounded bg-[var(--bg-violet)] transition-colors">
