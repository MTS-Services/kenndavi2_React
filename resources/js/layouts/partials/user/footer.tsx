...
export function UserFooter() {
    return (
          <section className="font-sans text-gray-900 overflow-x-hidden relative z-10">

          <footer className="bg-sidebar px-6 py-12 text-white">
          <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-4">
              ...
              <div className="flex space-x-2">
                  <a href="#" className="flex h-10 w-10 items-center justify-center rounded  transition-colors">
