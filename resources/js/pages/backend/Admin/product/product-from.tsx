    ...
    const submit = (e: React.FormEvent) => {
        ...
        post(
                ...
                : route("admin.products.store"),
            {
                ...
                preserveScroll: true,
                /*
                 * KEY FIX: do NOT call router.visit() here.
                 *
                 * When post() receives the server's redirect response,
                 * Inertia automatically follows it and navigates to the
                 * redirected page (index). The session flash is carried
                 * in that navigation's page props.
                 *
                 * Calling router.visit() inside onSuccess was causing a
                 * SECOND navigation with no flash, so the toast never
                 * appeared on the index page.
                 */
            ...
            <div className="bg-[#FDF7F7] w-full p-8 rounded-lg shadow-lg">
                ...
                <form onSubmit={submit}>
                    <FieldGroup>
                        ...
                        {/* ══ Offer Dates (only when discount set) ══ */}
                        {hasDiscount && (
                            <FieldSet>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <DatePickerField
