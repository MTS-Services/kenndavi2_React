        ...
        <UserLayout>
            <>
               <div className="bg-[var(--bg-grayslight)] text-gray-800">
                <div className="lg:hidden bg-[var(--bg-animasion)] p-4 flex justify-between items-center border-b border-gray-200">
                    <div className="w-8">
                ...
                <div className="flex min-h-screen relative">
                   ...
                   <div className="bg-[#f4eded] text-gray-800">
                      <div className="lg:hidden bg-[#FDF7F7] p-4 flex justify-between items-center border-b border-gray-200">
                        <div className="w-8">
                          <img src="images/Layer_1 (1).png" alt="Logo" className="max-w-full" />
                        </div>
                        <button id="menuBtn" className="text-red-600 text-2xl">
                          <i className="fas fa-bars" />
                        </button>
                      </div>
                      <div className="flex min-h-screen relative container mx-auto">
               
                        <div className="flex items-center justify-center p-4">
                          <div className="bg-[#FDF7F7] w-full p-8 rounded-lg shadow-lg relative min-h-3xl">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
                              <div className="aspect-square bg-[#f4eded] border border-stone-200 rounded flex items-center justify-center cursor-pointer hover:bg-stone-200 transition-colors">
                            ...
                            <div className="space-y-6">
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full bg-[#f4eded] border-none rounded p-3 focus:ring-2 focus:ring-red-600 outline-none"
                                />
                              </div>
                              ...
                              <div>
                                ...
                                <textarea
                                  ...
                                  className="w-full bg-[#f4eded] border-none rounded p-3 focus:ring-2 focus:ring-red-600 outline-none resize-none"
                                  defaultValue={""}
                                />
                              </div>
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                  ...
                                  <div className="relative">
                                    <select className="w-full bg-[#f4eded] border-none rounded p-3 appearance-none focus:ring-2 focus:ring-red-600 outline-none">
