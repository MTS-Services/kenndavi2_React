    ...
    return (
        <UserLayout>
          ...
          <div className="bg-[#FDF7F7] font-sans text-gray-900 overflow-x-hidden">
            ...
            <div className=" bg-[#fdf8f7] flex items-center justify-center font-sans p-4">
                <div className="bg-[#f4ecea] w-full max-w-5xl p-8 md:p-12 rounded-sm shadow-sm text-[#1a1a1a]">
                <div className="mb-8">
                ...
                <form onSubmit={(e) => { e.preventDefault(); /* TODO: Implement review submission */ }} className="space-y-8">
                    ...
                    <div className="flex gap-2">
                        <svg
                        className="w-8 h-8 text-[#facc15] fill-current"
                        viewBox="0 0 20 20"
                        >
                    ...
                    <button
                    type="submit"
                    className="bg-[#c22e2e] text-white px-10 py-3 font-medium rounded-md hover:bg-red-800 transition-colors font-['Alumni_Sans']"
                    >
                    Submit
                    </button>
                </form>
