        ...
        <FrontendLayout>
            ...
            <div>
               <>
                ...
                <div className=" bg-[var(--bg-fade)] flex items-center justify-center font-sans p-4">
                    ...
                    <form className="space-y-8">
                        ...
                        <button
                        type="submit"
                        className="bg-[var(--bg-red)] text-white px-10 py-3 font-medium rounded-md hover:bg-red-800 transition-colors font-['Alumni_Sans']"
                        >
                        Submit
                        </button>
                    </form>
