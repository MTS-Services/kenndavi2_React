...
export default function Home() {
    ...
    const showPreviousHero = () => {
        setCurrentHeroIndex((prev) => (prev - 1 + totalHeroSlides) % totalHeroSlides);
    };
    ...
    return (
        <FrontendLayout>
            ...
            <section className="bg-transparent font-sans text-white overflow-x-hidden">
                ...
                <div className="relative max-w-3xl z-20 text-center lg:text-left">
                    ...
                    <button onClick={() => router.get('/sweatsuitsmen')} className="bg-[var(--bg-red)] text-white px-10 py-3.5 text-sm font-medium font-['Libre_Franklin'] rounded hover:bg-black transition w-full sm:w-auto">
                ...
                <div className="relative lg:absolute right-0 lg:right-[-10%] top-0 h-[50vh] lg:h-full w-full lg:w-2/3 flex items-center justify-center lg:mt-12 mt-0"
                    ...
                    <img
                        ...
                        alt="Hero"
                        className="relative z-10 h-[80%] lg:h-[90%] object-contain drop-shadow-2xl"
                    />
                </div>

                <button
                    onClick={showPreviousHero}
                    className="absolute left-4 top-1/2 -translate-y-1/2 bg-[var(--bg-red)] text-white w-12 h-12 items-center justify-center rounded-md z-30"
                >
                ...
                <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 bg-[var(--bg-red)] text-white w-12 h-12 items-center justify-center rounded-md z-30"
                >
                    ...
                    <div className="grid grid-cols-2 gap-8">
                         ...
                         <div className="relative overflow-hidden rounded-md group cursor-pointer h-[174px] lg:h-[820px] w-full">
                            ...
                            <div
                                ...
                                style={{ backgroundImage: "url('/assets/images/Rectangle 9.jpg')" }}
                            >
                        ...
                        <div className="relative overflow-hidden rounded-md group cursor-pointer h-[174px] lg:h-[820px] w-full">
                            ...
                            <div
                                className="absolute inset-0 bg-cover bg-center bg-no-repeat w-full h-full transition-all duration-1000 ease-out group-hover:scale-110 group-hover:rotate-1"
                                style={{ backgroundImage: "url('/assets/images/Rectangle 11.jpg')" }}
                            >
                                {/* Dynamic Overlay that changes on hover */}
                                <div className="absolute inset-0 transition-all duration-700 bg-gradient-to-t from-transparent via-transparent to-transparent group-hover:from-black/40 group-hover:via-black/20 group-hover:to-transparent"></div>
                                <div className="absolute inset-0 transition-colors duration-500 backdrop-brightness-100 group-hover:backdrop-brightness-90"></div>
