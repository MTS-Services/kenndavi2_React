...
export default function ProductDetails2() {
  return (
    <FrontendLayout>
      ...
      <div className="relative min-h-screen bg-[var(--bg-animation)] font-sans overflow-x-hidden">
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 bg-transparent border border-[#110304B8] rounded-md focus:outline-none focus:ring-1 focus:ring-red-800"
                    />
                  </div>
                  <div>
                    <label className="block text-md font-bold mb-2 font-['Alumni_Sans']">
                ...
                <div className="flex items-center gap-3">
                  <input
                    type="checkbox"
                    id="save-address"
                    className="w-5 h-5 accent-red-700 border-[#110304B8] rounded"
                  />
            ...
            <div className="w-full lg:w-[380px] bg-[var(--bg-gray0)] p-6 md:p-8 rounded-sm self-start">
              ...
              <div className="space-y-3">
                <button onClick={() => router.get('/orderconfirmed')} className="w-full bg-[var(--bg-red)] text-white py-3 font-medium rounded-sm flex items-center justify-center gap-2 hover:bg-red-800 transition-colors">
                  Place Order
                  <svg
                ...
                <button onClick={() => window.history.back()} className="w-full border border-[var(--bg-red)] text-[var(--bg-red)] py-3 font-medium rounded-sm hover:bg-red-50 transition-colors">
                  Back
                </button>
              </div>
            </div>
