...
function GridItem({
    ...
    return (
        <>
            <div
                className={`group relative w-full cursor-pointer overflow-hidden rounded ${isLarge ? 'h-100 lg:h-212.5' : 'h-48 lg:h-105'}`}
            >
                ...
                <div className="relative z-10 flex h-full translate-y-8 flex-col items-center justify-center px-4 text-white opacity-0 transition-all duration-700 ease-out group-hover:translate-y-0 group-hover:opacity-100">
                    {/* Title */}
                    <h3 className="mb-2 text-center font-['Alumni_Sans'] text-xl font-semibold tracking-wide uppercase md:mb-4 md:text-3xl">
                        {title}
                    </h3>
                    ...
                    <button
                        ...
                        className="relative scale-75 overflow-hidden rounded bg-primary px-10 py-4 font-['Libre_Franklin'] text-base font-medium opacity-0 shadow-lg transition-all delay-200 duration-700 group-hover:scale-100 group-hover:opacity-100"
                    >
...
export default function ProductCategory({
    ...
    const navigateWithFiltersAndPage = (
        nextCategory: string,
        nextSubcategory: string,
        nextPage: number,
    ) => {
    ...
    const defaultSlots = [
        {
            img: '/assets/images/Rectangle 15 (5).png',
            title: 'Tracksuit Back',
            isLarge: true,
        },
        {
            img: '/assets/images/Rectangle 16 (6).png',
            title: 'Tracksuit Front',
            isLarge: true,
        },
        {
            img: '/assets/images/Rectangle 17 (2).png',
            title: 'Aces Box',
            isLarge: false,
        },
        {
            img: '/assets/images/Frame 98 (6).png',
            title: 'Hoodie Flat',
            isLarge: false,
        },
    ];
    ...
    return (
        <FrontendLayout>
            ...
            <section className="space-y-10 my-10 container mx-auto">
                {/* --- FILTER HEADER --- */}
