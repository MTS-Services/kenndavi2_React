    ...
    return (
        <FrontendLayout>
            ...
            >
             ...
             <div className="max-w-7xl mx-auto px-4 lg:px-8 lg:py-16 py-8 relative z-20">



            <div className="space-y-10 p-0 md:p-6 lg:p-10 bg-bg-animation rounded ">

            {/* Domestic Shipping */}
            <section className="p-2">
                 {/* Title */}
            <div className="text-center">
                <h1 className="text-4xl font-bold mb-2 font-[Alumni_Sans] text-gray-900">Shipping & Returns</h1>
            ...
            <section>
            <h2 className="text-2xl font-semibold mb-4 font-[Alumni_Sans] p-2">International Shipping Policy</h2>

            <p className="text-gray-600 leading-relaxed mb-4 font-[Libre_Franklin] p-2">
            ...
            {/* Tracking */}
            <section>
            <h2 className="text-2xl font-semibold mb-4 font-[Alumni_Sans] p-2">Shipment Confirmation & Order Tracking</h2>

            <p className="text-gray-600 leading-relaxed mb-4 p-2">
            ...
            {/* Returns */}
            <section>
            <h2 className="text-2xl font-semibold mb-4 font-[Alumni_Sans] p-2">Return & Exchange Policy</h2>
